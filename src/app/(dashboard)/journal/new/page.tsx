...
function NewTradePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <h1 className="text-2xl font-bold text-white mb-2">Log New Trade</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Link to Daily Plan */}
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1">Daily Plan</label>
          <select
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-1">Pair / Symbol</label>
            <input
              type="text"
              value={form.pair}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-1">Entry Time</label>
            <input
              type="datetime-local"
        ...
        {/* Entry Reason */}
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1">Entry Reason</label>
          <textarea
